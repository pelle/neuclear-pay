...
import org.neuclear.asset.TransferReceipt;
...
$Id: TransferReceiptBuilder.java,v 1.2 2003/11/06 23:47:43 pelle Exp $
...
public class TransferReceiptBuilder extends TransferBuilder {
    public TransferReceiptBuilder(TransferReceipt receipt) {
        super(TransferGlobals.XFER_RCPT_TAGNAME,
                receipt.getId(),
                receipt.getController().getIssuer().getID(),
                receipt.getTo().getID(),
                receipt.getAmount());
