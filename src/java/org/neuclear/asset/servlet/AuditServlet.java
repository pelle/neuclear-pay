...
$Id: AuditServlet.java,v 1.1 2004/07/21 16:00:53 pelle Exp $
$Log: AuditServlet.java,v $
Revision 1.1  2004/07/21 16:00:53  pelle
 ...
 * Time: 6:18:18 PM
 */
public final class AuditServlet extends ReceiverServlet {
    public final void init(final ServletConfig config) throws ServletException {
        super.init(config);
        AssetGlobals.registerReaders();
        TransferGlobals.registerReaders();
        try {
            Auditor auditor = new Auditor(ServletLedgerFactory.getInstance().createLedger(config));
            setReceiver(auditor);

        } catch (Exception e) {
            ctx.log("AuditControllerServer: " + e.getLocalizedMessage());
