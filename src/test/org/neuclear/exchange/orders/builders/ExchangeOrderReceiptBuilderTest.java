...
$Id: ExchangeOrderReceiptBuilderTest.java,v 1.1 2004/04/05 16:31:45 pelle Exp $
$Log: ExchangeOrderReceiptBuilderTest.java,v $
 ...
 * Time: 9:11:44 PM
 */
public class ExchangeOrderReceiptBuilderTest extends AbstractExchangeOrderTest {
    public ExchangeOrderReceiptBuilderTest(String string) throws NeuClearException, GeneralSecurityException {
        super(string);
    }

    protected void verifyObject(SignedNamedObject obj) throws NonExistingSignerException {
        assertNotNull(obj);
        assertTrue(obj instanceof ExchangeOrderReceipt);
...
//        assertEquals(getBob().getPublicKey().getEncoded(), order.getRecipient().getSignatory().getPublicKey().getEncoded());
    ...
    protected Class getRequiredClass() {
        return ExchangeOrderReceipt.class;
    }
    ...
    protected Builder createBuilder() throws NeuClearException, InvalidTransferException, XMLException {
        ...
        ExchangeOrderReceiptBuilder builder = new ExchangeOrderReceiptBuilder((ExchangeOrder) ob.convert("neu://test/bux", getSigner()), new Date());
        return builder;
    }
