 ...
 * Time: 1:38:45 PM
 */
public class TransferOrderReceiverWithFeesTest extends AbstractSigningTest {

    public TransferOrderReceiverWithFeesTest(String string) throws NeuClearException, GeneralSecurityException {
        super(string);
    ...
    public void testTransferOrder() throws NeuClearException, InvalidTransferException, LowlevelLedgerException, UnknownBookException, InvalidTransactionException {
        ...
        receiver.receive(new TransferOrderBuilder(asset, recipient, new Amount(amount), "test").convert("bob", signer));
