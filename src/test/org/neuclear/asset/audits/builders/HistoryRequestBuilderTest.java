...
$Id: HistoryRequestBuilderTest.java,v 1.1 2004/07/21 16:00:54 pelle Exp $
$Log: HistoryRequestBuilderTest.java,v $
 ...
 * Time: 9:11:44 PM
 */
public class HistoryRequestBuilderTest extends AbstractObjectCreationTest {
    public HistoryRequestBuilderTest(String string) throws NeuClearException, GeneralSecurityException {
        super(string);
    ...
    protected void verifyObject(SignedNamedObject obj) throws NonExistingSignerException {
        assertNotNull(obj);
        assertTrue(obj instanceof HistoryRequest);
        HistoryRequest order = (HistoryRequest) obj;
    ...
    protected Builder createBuilder() throws NeuClearException, InvalidTransferException, XMLException {
        Builder builder = new HistoryRequestBuilder(asset, null);
