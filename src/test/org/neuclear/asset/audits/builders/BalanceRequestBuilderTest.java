...
$Id: BalanceRequestBuilderTest.java,v 1.1 2004/07/21 16:00:54 pelle Exp $
$Log: BalanceRequestBuilderTest.java,v $
 ...
 * Time: 9:11:44 PM
 */
public class BalanceRequestBuilderTest extends AbstractObjectCreationTest {
    public BalanceRequestBuilderTest(String string) throws NeuClearException, GeneralSecurityException {
        super(string);
    ...
    protected void verifyObject(SignedNamedObject obj) throws NonExistingSignerException {
        assertNotNull(obj);
        assertTrue(obj instanceof BalanceRequest);
        BalanceRequest order = (BalanceRequest) obj;
    ...
    protected Builder createBuilder() throws NeuClearException, InvalidTransferException, XMLException {
        Builder builder = new BalanceRequestBuilder(asset);
