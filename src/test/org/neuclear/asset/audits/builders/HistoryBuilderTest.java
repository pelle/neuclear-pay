...
$Id: HistoryBuilderTest.java,v 1.1 2004/07/21 16:00:54 pelle Exp $
$Log: HistoryBuilderTest.java,v $
 ...
 * Time: 9:11:44 PM
 */
public class HistoryBuilderTest extends AbstractObjectCreationTest {
    public HistoryBuilderTest(String string) throws NeuClearException, GeneralSecurityException {
        super(string);
    ...
    protected void verifyObject(SignedNamedObject obj) throws NonExistingSignerException {
        ...
        assertNotNull(history.getReq());
        assertNotNull(history.getTime());
        HistoryRequest req = history.getReq();
        assertNotNull(req.getAsset());
        assertNotNull(history.iterate());
    }
    ...
    protected Builder createBuilder() throws NeuClearException, InvalidTransferException, XMLException, LowlevelLedgerException {
        LedgerBrowser lb = new SimpleLedgerController("test");
        Builder builder = new HistoryBuilder((HistoryRequest) new HistoryRequestBuilder(asset, null).convert("alice", getSigner()), lb.browse("alice"), new Date());
